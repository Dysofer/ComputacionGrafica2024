...
function createLight(typeLight) {
    switch(typeLight) {
        case "ambient":
            myLight = new THREE.AmbientLight(0xffffff, 1);
            scene.add(myLight);
            break;
...
function createGrassGround() {
    // Crear el suelo de pasto para toda la ciudad
    const grassTexture = new THREE.TextureLoader().load('../src/img/facesImage/pasto.jpg');
...
function createStraightRoad() {
    ...
    const roadTexture = new THREE.TextureLoader().load('../src/img/facesImage/carretera.png');
...
function createCornerBuildings() {
    ...
    const textures = [
        new THREE.TextureLoader().load('../src/img/facesImage/edificio1.jpeg'),
        new THREE.TextureLoader().load('../src/img/facesImage/edificio2.jpeg')
    ];
...
function createAdditionalBuildings() {
    ...
    const textures = [
        new THREE.TextureLoader().load('../src/img/facesImage/edificio1.jpeg'),
        new THREE.TextureLoader().load('../src/img/facesImage/edificio2.jpeg'),
        new THREE.TextureLoader().load('../src/img/facesImage/edificio3.jpeg')
    ];
...
function createTrees() {
    // Textura de árboles
    const treeTexture = new THREE.TextureLoader().load('../src/img/facesImage/arbol.jpg');
